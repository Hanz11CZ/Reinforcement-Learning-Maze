...
function isOutOfBoard(state,action) {
    switch (action) {
        case 0:
            // UP
            try {
...
function go(startingState) {
        ...
        if(exploitOrExplore(0.8) == "explore") {
            ...
            let action_to_take = getRandomInt(4);
            console.log("before while loop: "+action_to_take)
            while (isOutOfBoard(startingState,action_to_take)) {
                action_to_take = getRandomInt(4);
            }
            console.log("after the while loop: "+action_to_take)
            // Base case:
            ...
            while (isOutOfBoard(startingState,best_action[1])) {
                best_action[1] = getRandomInt(4);
            }
